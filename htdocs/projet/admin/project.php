...
if (!$conf->use_javascript_ajax) {
	...
	print $form->selectarray("activate_PROJECT_USE_SEARCH_TO_SELECT", $arrval, $conf->global->PROJECT_USE_SEARCH_TO_SELECT ?? null);
	print '</td><td class="right">';
...
print '<input type="text" id="projectToSelect" name="projectToSelect" value="'.($conf->global->PROJECT_ALLOW_TO_LINK_FROM_OTHER_COMPANY ?? null).'"/>&nbsp;';
...
print '<td class="right" width="60" colspan="2">';
print '<input type="number" class="width50" id="timesheetFreezeDuration" name="timesheetFreezeDuration" min="0" step="1" value="'.($conf->global->PROJECT_TIMESHEET_PREVENT_AFTER_MONTHS ?? null).'"/>&nbsp;';
